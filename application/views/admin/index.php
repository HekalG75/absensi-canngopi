             ...
             <div class="card border-left-primary shadow h-100 py-2">
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                     <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Bagian</div>
                     <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $display['c_department']; ?> Department</div>
                   </div>
                   <div class="col-auto">
               ...
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                     ...
                     <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $display['c_shift']; ?> Shift</div>
                   </div>
                   <div class="col-auto">
             ...
             <div class="col p-0">
               <div class="card shadow mb-4">
                 ...
                 <div class="card-header py-3 d-flex flex-rowz align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-primary">Department Karyawan</h6>
                   <div class="dropdown no-arrow">
                     ...
                     <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                       ...
                       <a class="dropdown-item" href="<?= base_url('admin') ?>">Daftar Department</a>
                     </div>
                   </div>
                 </div>
                 <!-- Card Body -->
             ...
             <div class="col p-0">
               <div class="card shadow mb-4">
                 ...
                 <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-primary">Karyawan per Shift</h6>
                 </div>
                 <!-- Card Body -->
